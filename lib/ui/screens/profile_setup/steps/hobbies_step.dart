...
class _HobbiesStepState extends State<HobbiesStep> {
  ...
  List<Map<String, dynamic>> _buildHobbies() {
    return [
      {
        'value': 'Lectura',
        'trKey': 'hobbies.reading',
        'icon': Icons.menu_book_rounded,
        'color': const Color(0xFF8B5CF6),
      },
      {
        'value': 'Deportes',
        'trKey': 'hobbies.sports',
        'icon': Icons.sports_soccer_rounded,
        'color': const Color(0xFF10B981),
      },
      {
        'value': 'Meditación',
        'trKey': 'hobbies.meditation',
        'icon': Icons.self_improvement_rounded,
        'color': const Color(0xFF06B6D4),
      },
      {
        'value': 'Cocina',
        'trKey': 'hobbies.cooking',
      ...
      {
        'value': 'Viajar',
        'trKey': 'hobbies.travel',
        'icon': Icons.flight_rounded,
        'color': const Color(0xFF3B82F6),
      },
      {
        'value': 'Fotografía',
        'trKey': 'hobbies.photography',
        'icon': Icons.camera_alt_rounded,
        'color': const Color(0xFFF97316),
      },
      {
        'value': 'Videojuegos',
        'trKey': 'hobbies.gaming',
      ...
      {
        'value': 'Naturaleza',
        'trKey': 'hobbies.nature',
        'icon': Icons.park_rounded,
        'color': const Color(0xFF22C55E),
      },
      {
        'value': 'Voluntariado',
        'trKey': 'hobbies.volunteering',
        'icon': Icons.volunteer_activism_rounded,
        'color': const Color(0xFFEC4899),
      },
      {
        'value': 'Fiestas',
        'trKey': 'hobbies.parties',
        'icon': Icons.celebration_rounded,
        'color': const Color(0xFFF59E0B),
      },
      {
        'value': 'Artes marciales',
        'trKey': 'hobbies.martialArts',
  ...
  Widget build(BuildContext context) {
    final hobbies = _buildHobbies();
    final remaining = 3 - _selected.length;
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          Text(
            'profileSetup.selectAtLeast3'.tr(),
            style: TextStyle(
              fontSize: 16,
          ...
          Container(
            ...
            child: Wrap(
              ...
              children: List.generate(hobbies.length, (index) {
                ...
                final isSelected = _selected.contains(hobby['value']);
                final Color hobbyColor = hobby['color'];
                return GestureDetector(
                  onTap: () {
                    setState(() {
                      if (isSelected) {
                        _selected.remove(hobby['value']);
                      } else {
                        _selected.add(hobby['value']);
                      }
                    });
                  },
                  child: AnimatedContainer(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: isSelected
                          ? [
                              BoxShadow(
                                color: hobbyColor.withValues(alpha: 0.2),
                                blurRadius: 8,
                              ),
                            ]
                          : [],
