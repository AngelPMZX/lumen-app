...
class _AboutYouStepState extends State<AboutYouStep> {
  ...
  List<Map<String, dynamic>> _buildGenders() {
    return [
      {
        'label': 'profileSetup.genderMale'.tr(),
        'value': 'Masculino',
        'icon': Icons.male_rounded,
        'color': const Color(0xFF3B82F6),
      },
      {
        'label': 'profileSetup.genderFemale'.tr(),
        'value': 'Femenino',
        'icon': Icons.female_rounded,
        'color': const Color(0xFFEC4899),
      },
      {
        'label': 'profileSetup.genderNonBinary'.tr(),
        'value': 'No binario',
        'icon': Icons.transgender_rounded,
        'color': const Color(0xFF8B5CF6),
      },
      {
        'label': 'profileSetup.genderPreferNotSay'.tr(),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          Text(
            'profileSetup.personalizeExp'.tr(),
            style: TextStyle(
              fontSize: 16,
            ...
            child: Column(
              ...
              children: [
                ...
                ...List.generate(genders.length, (index) {
                  ...
                  final hasError = _showGenderError && _selectedGender == null;
                  return Padding(
                            ...
                            child: Row(
                              children: [
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: isSelected
                                        ? (gender['color'] as Color).withValues(
                                            alpha: 0.3,
                                          )
          ...
          Container(
            ...
            child: ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                ...
                elevation: (_selectedAge != null && _selectedGender != null)
                    ? 4
                    : 0,
