...
class _OnboardingScreenState extends State<OnboardingScreen>
  ...
  final List<_OnboardingData> _pages = [
    _OnboardingData(
      title: 'Bienvenido a\nLumen',
      description:
          'Un espacio seguro para fortalecer tu bienestar emocional, un día a la vez.',
      gradientColors: [
    ...
    _OnboardingData(
      ...
      description:
          'Lecciones cortas, ejercicios prácticos y seguimiento diario de tu estado emocional.',
      gradientColors: [
    ...
    _OnboardingData(
      ...
      description:
          'Gana XP, sube de nivel y desbloquea contenido mientras cuidas de ti mismo.',
      gradientColors: [
...
class _BgPatternPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 15; i++) {
      ...
      final y = (baseY - progress * speed * size.height * 0.3) %
          size.height;
      final currentOpacity =
          (0.08 + 0.12 * sin(progress * pi * 2 + phase)).clamp(0.0, 1.0);
